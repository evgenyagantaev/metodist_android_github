...
public class DataService extends Service {
    ...
    public void onCreate() {
        ...
        udp = new Udp();
        gps_mass = new String[5];
        gps_mass[0] = "59.970063d30.357513X";
        gps_mass[1] = "59.970584d30.361632X";
        gps_mass[2] = "59.970938d30.361482X";
        gps_mass[3] = "59.970460d30.359508X";
        gps_mass[4] = "59.970740d30.359122X";
        ...
        Thread th = new Thread(new Runnable() {
            public void run() {
                while (deviceFound != null) {
                    ...
                    //// str hundle ///////
                    if (send_str.contains("c")) {
                        send_str = send_str.substring(0,17);
                        if (cnt_gps == 5)
                            cnt_gps = 0;
                        send_str = send_str + gps_mass[cnt_gps] + "\r\n";


                        String c_gen = "c" + Integer.toString(cnt_gps);
                        //send_str.replace("c0",c_gen);
                        send_str = c_gen + send_str.substring(2);
                        cnt_gps ++;
